...
{
public:
    MassSpringNode() : Node("mass_spring_cp3_node")
    {
        // Marker publisher
        ...
        // Energy publishers
        ke_pub_ = this->create_publisher<std_msgs::msg::Float64>(
            "kinetic_energy", 10);
        pe_pub_ = this->create_publisher<std_msgs::msg::Float64>(
            "potential_energy", 10);
        ...
        increase_k_srv_ = this->create_service<std_srvs::srv::Trigger>(
            "increase_k",
            std::bind(&MassSpringNode::increase_k, this,
                      std::placeholders::_1, std::placeholders::_2));

        increase_b_srv_ = this->create_service<std_srvs::srv::Trigger>(
            "increase_b",
            std::bind(&MassSpringNode::increase_b, this,
                      std::placeholders::_1, std::placeholders::_2));
...
private:
        ...
        std::shared_ptr<std_srvs::srv::Trigger::Response> response)
    {
        k_ += 1.0;
        response->success = true;
        response->message = "Spring constant k increased";
    }
        ...
        std::shared_ptr<std_srvs::srv::Trigger::Response> response)
    {
        b_ += 0.05;
        response->success = true;
        response->message = "Damping coefficient b increased";
    }

    // ---------- RViz VISUALIZATION (CP2 STYLE) ----------
    ...
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr increase_k_srv_;
    rclcpp::Service<std_srvs::srv::Trigger>::SharedPtr increase_b_srv_;
