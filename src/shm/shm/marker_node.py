...
class MassSpringMarkers(Node):
    def __init__(self):
        ...
        self.fixed_marker.header.frame_id = 'map'
        ...
        self.fixed_marker.pose.orientation.x = 0.0
        self.fixed_marker.pose.orientation.y = 0.0
        self.fixed_marker.pose.orientation.z = 0.0
        self.fixed_marker.pose.orientation.w = 1.0

        self.mass_marker = Marker()
        self.mass_marker.header.frame_id = 'map'
        ...
        self.mass_marker.pose.orientation.x = 0.0
        self.mass_marker.pose.orientation.y = 0.0
        self.mass_marker.pose.orientation.z = 0.0
        self.mass_marker.pose.orientation.w = 1.0


        self.spring_marker = Marker()
        self.spring_marker.header.frame_id = 'map'
