...
#include "my_robot_description/srv/detail/set_velocity__rosidl_typesupport_fastrtps_c.h"
...
using _SetVelocity_Request__ros_msg_type = my_robot_description__srv__SetVelocity_Request;
...
size_t get_serialized_size_my_robot_description__srv__SetVelocity_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetVelocity_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_description__srv__SetVelocity_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_description
size_t max_serialized_size_my_robot_description__srv__SetVelocity_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_description__srv__SetVelocity_Request;
    is_plain =
      (
...
static size_t _SetVelocity_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_description__srv__SetVelocity_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_description, srv, SetVelocity_Request)() {
...
using _SetVelocity_Response__ros_msg_type = my_robot_description__srv__SetVelocity_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_description
size_t get_serialized_size_my_robot_description__srv__SetVelocity_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetVelocity_Response__ros_msg_type * ros_message = static_cast<const _SetVelocity_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_description__srv__SetVelocity_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_description
size_t max_serialized_size_my_robot_description__srv__SetVelocity_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_description__srv__SetVelocity_Response;
    is_plain =
      (
...
static size_t _SetVelocity_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_description__srv__SetVelocity_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_description, srv, SetVelocity_Response)() {
...
// already included above
// #include "my_robot_description/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_description/srv/set_velocity.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_description, srv, SetVelocity)() {
