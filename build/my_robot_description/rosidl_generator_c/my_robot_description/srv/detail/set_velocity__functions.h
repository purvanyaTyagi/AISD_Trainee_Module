...
#ifndef MY_ROBOT_DESCRIPTION__SRV__DETAIL__SET_VELOCITY__FUNCTIONS_H_
#define MY_ROBOT_DESCRIPTION__SRV__DETAIL__SET_VELOCITY__FUNCTIONS_H_
 ...
 * calls
 * my_robot_description__srv__SetVelocity_Request__init().
...
/**
 * It calls
 * my_robot_description__srv__SetVelocity_Request__fini()
 ...
 * my_robot_description__srv__SetVelocity_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * my_robot_description__srv__SetVelocity_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_robot_description__srv__SetVelocity_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_description
...
/**
 * It calls
 * my_robot_description__srv__SetVelocity_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_description
...
/**
 * It allocates the memory for the array and calls
 * my_robot_description__srv__SetVelocity_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_robot_description
...
/**
 * It calls
 * my_robot_description__srv__SetVelocity_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_ROBOT_DESCRIPTION__SRV__DETAIL__SET_VELOCITY__FUNCTIONS_H_
