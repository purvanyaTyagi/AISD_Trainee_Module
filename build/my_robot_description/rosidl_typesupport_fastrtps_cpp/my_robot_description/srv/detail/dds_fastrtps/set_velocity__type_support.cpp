...
#include "my_robot_description/srv/detail/set_velocity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_description::srv::SetVelocity_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_description::srv::SetVelocity_Request & ros_message)
{
  // Member: linear_x
  cdr >> ros_message.linear_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_description::srv::SetVelocity_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_description::srv::SetVelocity_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_description::srv::SetVelocity_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_my_robot_description
const rosidl_message_type_support_t *
get_message_type_support_handle<my_robot_description::srv::SetVelocity_Request>()
{
  return &my_robot_description::srv::typesupport_fastrtps_cpp::_SetVelocity_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_description, srv, SetVelocity_Request)() {
  return &my_robot_description::srv::typesupport_fastrtps_cpp::_SetVelocity_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_description
cdr_serialize(
  const my_robot_description::srv::SetVelocity_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_description::srv::SetVelocity_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_description::srv::SetVelocity_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_description::srv::SetVelocity_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_description::srv::SetVelocity_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_description::srv::typesupport_fastrtps_cpp::_SetVelocity_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_description, srv, SetVelocity_Response)() {
  return &my_robot_description::srv::typesupport_fastrtps_cpp::_SetVelocity_Response__handle;
}
...
{
  return &my_robot_description::srv::typesupport_fastrtps_cpp::_SetVelocity__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_description, srv, SetVelocity)() {
  return &my_robot_description::srv::typesupport_fastrtps_cpp::_SetVelocity__handle;
}
