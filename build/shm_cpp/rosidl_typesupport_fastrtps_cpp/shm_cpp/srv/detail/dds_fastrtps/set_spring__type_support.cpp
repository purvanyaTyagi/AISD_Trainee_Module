...
#include "shm_cpp/srv/detail/set_spring__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shm_cpp::srv::SetSpring_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const shm_cpp::srv::SetSpring_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<shm_cpp::srv::SetSpring_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetSpring_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const shm_cpp::srv::SetSpring_Request *>(
...
static size_t _SetSpring_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetSpring_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetSpring_Request__callbacks = {
  "shm_cpp::srv",
  "SetSpring_Request",
...
static rosidl_message_type_support_t _SetSpring_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetSpring_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_shm_cpp
const rosidl_message_type_support_t *
get_message_type_support_handle<shm_cpp::srv::SetSpring_Request>()
{
  return &shm_cpp::srv::typesupport_fastrtps_cpp::_SetSpring_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = shm_cpp::srv::SetSpring_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const shm_cpp::srv::SetSpring_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<shm_cpp::srv::SetSpring_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetSpring_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const shm_cpp::srv::SetSpring_Response *>(
...
static size_t _SetSpring_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetSpring_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetSpring_Response__callbacks = {
  "shm_cpp::srv",
  "SetSpring_Response",
...
static rosidl_message_type_support_t _SetSpring_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetSpring_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &shm_cpp::srv::typesupport_fastrtps_cpp::_SetSpring_Response__handle;
}
...
static service_type_support_callbacks_t _SetSpring__callbacks = {
  "shm_cpp::srv",
  "SetSpring",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shm_cpp, srv, SetSpring_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, shm_cpp, srv, SetSpring_Response)(),
...
static rosidl_service_type_support_t _SetSpring__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetSpring__callbacks,
...
{
  return &shm_cpp::srv::typesupport_fastrtps_cpp::_SetSpring__handle;
}
