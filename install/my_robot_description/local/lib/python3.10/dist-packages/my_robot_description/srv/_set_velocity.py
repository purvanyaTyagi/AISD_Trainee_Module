...
class Metaclass_SetVelocity_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('my_robot_description')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetVelocity(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_description.srv.SetVelocity')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_description.srv import _set_velocity
...
class SetVelocity(metaclass=Metaclass_SetVelocity):
    from my_robot_description.srv._set_velocity import SetVelocity_Request as Request
    from my_robot_description.srv._set_velocity import SetVelocity_Response as Response
